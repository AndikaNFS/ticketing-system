...
<div class="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-xl border border-default ">
    <div class="p-4 flex items-center justify-between text-gray-300">
        ...
        <!-- Dropdown menu -->
        <div id="dropdown" class="z-10 hidden bg-neutral-700 border border-default-medium rounded-base shadow-lg w-32">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-body">
        <thead class="text-sm text-body bg-neutral-secondary-medium border-b border-t border-default-medium text-gray-300 bg-gray-600">
            <tr>
        ...
        <tbody>
            <tr class="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium text-gray-400">
