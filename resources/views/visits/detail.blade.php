<x-app-layout>
    <div class=" flex items-center ">
        <div class="relative p-3 ">
            <a href="{{ route('visits.index') }}" class="text-white p-3 text-lg   dark:text-gray-700 max-w-min ">
        ...
        <h1 class="text-gray-800 dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center">Details Visit Schedule</h1>
