<x-app-layout>
        ...
        <div class=" grid grid-cols-3 items-center">
            ...
            <h1 class="text-gray-800  dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center">Form Add PIC</h1>
            <div class=" pe-1 px-5">
                {{-- <span>aaa</span> --}}
            </div>
        </div>
        ...
        <form action="{{ route('building.pics.store') }}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto mt-10">
            @csrf 
