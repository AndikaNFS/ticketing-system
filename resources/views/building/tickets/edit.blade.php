...
@endif
    ...
    <div class=" grid grid-cols-3 items-center">
        ...
        <h1 class="text-gray-800  dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center sm:text-black">Form Edit Ticketing</h1>
        <div class=" pe-1 px-5">
            {{-- <span>aaa</span> --}}
        </div>
    </div>
...
<form action="{{ isset($building) ? route('building.tickets.update', $building->id) : route('building.tickets.store') }}" id="ticketForm" method="post" enctype="multipart/form-data" class="max-w-md mx-auto mt-10">
        ...
        {{-- @if ($ticket->editor) --}}
            <div class="flex space-x-5 mb-5 text-gray-900 dark:text-white">
                <p class="text-l text-gray-500">Edited By : 
                    <span class="font-sans">{{ $building->editor ? $building->editor->name : '-' }}</span>

                </p>
            </div>
            <div class="flex space-x-5 mb-5 text-gray-900 dark:text-white">
                <p class="text-l text-gray-500">Last edited : 
                    <span class="font-sans">{{ $building->updated_at->format('d M Y H:i') }}</span>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            ...
            <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        onchange="if(['Done','Cancel'].includes(this.value)) document.getElementById('ticketForm').submit();"
                        >
