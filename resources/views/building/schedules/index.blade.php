...
{{-- <div class="container mx-auto py-8 "> --}}
    ...
    <div class="grip col-span-2 gap-4">
        ...
        <div class="mb-6 flex items-center gap-4 ">
            <a href="{{ route('building.schedules.exports.pdf', ['bulan' => $bulan]) }}" class="bg-red-500 text-white px-4 py-1 rounded hover:bg-red-600">Export PDF</a>
            <a href="{{ route('building.schedules.exports.excel', ['bulan' => $bulan]) }}" class="bg-green-500 text-white px-4 py-1 rounded hover:bg-green-600">Export Excel</a>
                ...
                <tbody>
                    @foreach ($employees as $employee)
                        @php
                            ...
                            $offDays = 0;
                            $remarks = [];
                            $schedules = $employee->schedulebuildings->keyBy('date');
                        @endphp
