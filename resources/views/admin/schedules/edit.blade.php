<x-app-layout>
    ...
    <div class=" grid grid-cols-3 items-center">
        <div class="relative p-3 ">
            <a href="{{ route('schedules.index') }}" class="text-white p-3 text-lg m-10 rounded-full  dark:text-gray-700 max-w-min ">
        ...
        <h1 class="text-gray-800  dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center">Employee Schedule Editor</h1>
        <div class=" pe-1 px-5">
            {{-- <span>aaa</span> --}}
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="border px-2 py-1">
                            <select name="schedule[{{ $date->toDateString() }}][status]" class="w-full border px-1 py-1 rounded">
                                @foreach(['Work', 'Off', 'Izin','Sakit', 'Cuti', 'Libur Nasional'] as $option)
