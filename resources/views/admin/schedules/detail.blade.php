<x-app-layout>
    ...
    <div class=" grid grid-cols-3 items-center">
        ...
        <h1 class="text-gray-800  dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center">Employee Schedule Details</h1>
        <div class=" pe-1 px-5">
            {{-- <span>aaa</span> --}}
        </div>
    </div>
...
<div class="max-w-3xl mx-auto mt-6 bg-white p-6 rounded shadow">
    ...
    <form action="{{ url('/schedules/' . $employee->id . '/store?start_date=' . request('start_date')) }}" method="POST">
        ...
        <table class="w-full table-auto text-sm border border-gray-300">
            ...
            @php
                $schedule = $existing[$date->format('Y-m-d')] ?? null;
            @endphp
            <tr>
