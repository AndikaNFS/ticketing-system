<x-app-layout>
    ...
    <div class=" grid grid-cols-3 items-center">
        ...
        <h1 class="text-gray-800  dark:text-gray-100 text-xl md:text-3xl m-5 max-w-md mx-auto text-center">Form Edit Employee IT Support</h1>
        <div class=" pe-1 px-5">
        </div>
    </div>

    <form action="{{ route('employees.it.update', $employeeit->id) }}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto mt-10 p-3">
        @csrf
        @method('PUT')
    ...
    <div class="mb-5 mt-5">
        ...
        <input type="text" name="name" id="name" value=" {{ old('name', $employeeit->name ) }}"
    ...
    <div class="mb-5 mt-5">
        ...
        <input type="text" name="position" id="position" value=" {{ old('position', $employeeit->position ) }}"
            class="w-full text-gray-900 bg-gray-300 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."
        ></input>
    </div>
    <div class="mb-5 mt-5">
        ...
        <input type="text" name="phone_number" id="phone_number" value=" {{ old('phone_number', $employeeit->phone_number ) }}"
            class="w-full text-gray-900 bg-gray-300 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="62812345789"
        ></input>
    </div>
    <div class="mb-5 mt-5">
        
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">email</label>
        <input type="email" name="email" id="email" value=" {{ old('email', $employeeit->email ) }}"
    ...
    <div class="mb-5 mt-5">
        ...
        <input type="hidden" name="is_active" id="is_active" value=" {{ old('is_active', $employeeit->is_active ) }}"
            class="w-full text-gray-900 bg-gray-300 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."
        ></input>
    </div>
    {{-- @endforeach --}}
