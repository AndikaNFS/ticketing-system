<x-user-layout>
        ...
        <form action="{{ route('tickets.users.storeUser') }}" id="ticketForm" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto mt-10">
            @csrf
        ...
        <script>
            ...
            fetch("{{ route('tickets.users.storeUser') }}" , {
                method: "POST",
                body: formData,
                header: {
